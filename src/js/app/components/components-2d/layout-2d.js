...
export default class Layout2D extends DisplayObject {
  ...
  onResize() {
    ...
    this._hint.x = Black.stage.centerX;
    this._hint.y = Black.stage.centerY + bb.height * 0.18;


    this._moneybar.x = Black.stage.centerX;
    this._moneybar.y = Black.stage.centerY * 0.18;
  ...
  onDown(x, y) {
    ...
    document.addEventListener("click", this.moneyCounter());
    this.showHandHint();
